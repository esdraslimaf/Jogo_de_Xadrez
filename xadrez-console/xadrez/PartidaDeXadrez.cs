...
namespace xadrez
{
     class PartidaDeXadrez
    {
        ...
        public Peca podeTomarEnPassant { get; private set; }
        ...
        public void desfazMovimento(Posicao origem, Posicao destino, Peca pecaCapturada)
        {
            ...
            if (p is Peao)
            {
                if (origem.coluna != destino.coluna && pecaCapturada == podeTomarEnPassant)
                {
    ...
    public void realizaJogada(Posicao origem, Posicao destino)
        ...
        public void validarPosicaoDeOrigem(Posicao pos)
        {
            ...
            {
                throw new TabuleiroException("A peça que você escolheu é do outro jogador!");
            }
